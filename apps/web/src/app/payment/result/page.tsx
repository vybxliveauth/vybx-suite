  ...
  if (status === "loading") {
    return (
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "1rem" }}>
        ...
        <p style={{ color: "var(--text-muted)", fontSize: "1rem" }}>Verificando tu pago...</p>
      </div>
    );
  }
        ...
        <div>
          ...
          <p style={{ color: "var(--text-muted)", fontSize: "1rem", maxWidth: 360 }}>
            {queue
              ...
              : "Tus tickets han sido emitidos. Recibirás un email de confirmación en breve."}
          </p>
        </div>
        <div style={{
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "1.5rem", textAlign: "center" }}>
      ...
      <div>
        ...
        <p style={{ color: "var(--text-muted)", fontSize: "1rem", maxWidth: 360 }}>
          {errorMsg || "Hubo un problema procesando tu pago. Intenta de nuevo."}
        </p>
      </div>
