...
const styles = StyleSheet.create({
  ...
  errorText: { color: colors.danger, fontSize: 15, textAlign: "center", marginBottom: 12 },
  ...
  qrLabel: { fontSize: 11, color: colors.textMuted, fontWeight: "600", textTransform: "uppercase" },
